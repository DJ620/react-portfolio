    ...
    return (
        <div className="row" style={{marginTop: "80px", paddingBottom: "100px"}}>
            <Col attributes="col-12 col-lg-7 pl-lg-0 pr-lg-5">
                ...
                <h5 className="text-white mb-5 about-me">Before I decided to jump into the world of coding, I was living in New York City pursuing a career as an actor. I know, kinda cliche, but I enjoyed my life. I was working as a server (an actor working as a server? Never...) at Ellen's Stardust Diner.
            ...
            <Col attributes="col-12 ml-md-5 ml-lg-0 pl-md-5 pl-lg-0 col-lg-5 mt-lg-5 mt-xl-3 pt-lg-5 pt-xl-0 pr-lg-0">
                <img src={Headshot} alt="DJ Headshot" className="img-fluid mb-xl-5 headshot" />
            </Col>
        </div>
    );
};
